...
2.  #### [Инициализация Базы Данных](#инициализация-базы-данных-1)
3.  #### [Инициализация Сервера](#инициализация-сервера-1)
4.  #### [Настройка Сервера](#настройка-сервера-1)
5.  #### [Инициализация Клиента](#инициализация-клиента-1)
6.  #### [Настройка Клиента](#настройка-клиента-1)

### [Запуск](#запуск-1)

1.  #### [Запуск приложения](#запуск-приложения-1)
...
Для запуска приложения должны быть выполнены предыдущие пункты по Инициализации и Настройке [БД](#инициализация-базы-данных-1), [Сервера](#инициализация-сервера-1) и [Клиента](#инициализация-клиента-1).
